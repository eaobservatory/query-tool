...
\"}\"'>'n '>'n'>")))
 ...
 '(jde-bug-debugger-host-address "kapili")
 ...
 '(jde-global-classpath (quote ("." "/local/java/jdk1.3/jre/lib/rt.jar" "/home/mrippa/local/ant/lib/ant.jar" "/local/java/jdk1.3/lib/tools.jar" "/home/mrippa/local/cc/lib/xalan.jar" "/home/mrippa/local/cc/lib/xerces.jar" "/home/mrippa/local/cc/lib/junit.jar" "/home/mrippa/local/cc/dist/cruisecontrol.jar" "/home/mrippa/local/cc/lib/optional.jar" "/home/mrippa/local/tomcat/lib/webserver.jar" "/home/mrippa/local/tomcat/lib/servlet.jar" "/home/mrippa/local/tomcat/lib/jasper.jar" "/home/mrippa/local/tomcat/lib/parser.jar" "/home/mrippa/src/java/jfcunit/jfcunit.jar" "/home/mrippa/root/install/javaClasses" "/home/mrippa/root/install/javaClasses/QT/classes" "/home/mrippa/root/install/javaClasses/utils/soap.jar" "/home/mrippa/root/install/javaClasses/utils/activation.jar" "/home/mrippa/root/install/javaClasses/utils/mail.jar" "/home/mrippa/root/src/orac3/GEMINI/install/classes" "/home/mrippa/root/src/orac3/ORAC/install/classes" "/home/mrippa/root/src/orac3/OT/install/classes")) t)
 ...
 '(jde-jdk-doc-url "http://java.sun.com/j2se/1.3/docs/api/index.html")
 '(jde-gen-cflow-enable t)
 '(jde-compiler "javac")
 '(jde-javadoc-gen-verbose nil)
 '(jde-javadoc-describe-method-template "\"* Describe \" (jde-javadoc-code name) \" method here.\"")
 '(jde-gen-class-buffer-template (quote ("(funcall jde-gen-boilerplate-function)" "(jde-gen-get-package-statement)" "\"/**\" '>'n" "\" * \"" "(file-name-nondirectory buffer-file-name) '>'n" "\" *\" '>'n" "\" *\" '>'n" "\" * Created: \" (current-time-string) '>'n" "\" *\" '>'n" "\" * @author <a href=\\\"mailto: mrippa@jach.hawaii.edu\\\"\" (user-full-name) \"</a>\"'>'n" "\" */\" '>'n'" "'>'n" "\"public class \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\" \" (jde-gen-get-super-class)" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"public \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\" ()\"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "'>'p'n" "\"}\">" "'>'n" "\"}\">" "\"// \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "'>'n")))
 ...
 '(jde-make-program "~/local/ant/bin/ant")
 ...
 '(jde-compile-option-directory "/home/mrippa/root/install/javaClasses")
 '(jde-imenu-create-index-function (quote semantic-create-imenu-index))
 '(jde-gen-console-buffer-template (quote ("(funcall jde-gen-boilerplate-function)" "(jde-gen-get-package-statement)" "\"/**\" '>'n" "\" * \"" "(file-name-nondirectory buffer-file-name) '>'n" "\" *\" '>'n" "\" *\" '>'n" "\" * Created: \" (current-time-string) '>'n" "\" *\" '>'n" "\" * @author <a href=\\\"mailto: mrippa@jach.hawaii.edu\\\"\" (user-full-name) \"</a>\"'>'n" "\" */\" '>'n" "'>'n" "\"public class \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"public \"" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "\" ()\"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "'>'n" "\"}\"'>'n" "'>'n" "\"public static void main(String[] args)\"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "'>'p'n" "\"}\"'>'n" "\"} // \"'>" "(file-name-sans-extension (file-name-nondirectory buffer-file-name))" "'>'n")))
 ...
 '(jde-db-source-directories (quote ("/home/mrippa/root/src/omp/omp/QT/src/main" "/local/java/jdk/src.jar" "/home/mrippa/root/src/orac3/GEMINI/src" "/home/mrippa/root/src/orac3/ORAC/src" "/home/mrippa/root/src/orac3/OT/src" "/home/mrippa/root/src/orac3/ODB/src" "/home/mrippa/root/src/orac3/OM/src")) t)
 ...
 '(jde-bug-jdk-directory "/local/java/jdk" t)
...
\"java.rmi.RemoteException\"))" "'> \"public void ejbActivate() throws RemoteException \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"}\"'>'n '>'n" "'> \"public void ejbPassivate() throws RemoteException \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"}\"'>'n '>'n" "'> \"public void ejbLoad() throws RemoteException \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"}\"'>'n '>'n" "'> \"public void ejbStore() throws RemoteException \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"}\"'>'n '>'n" "'> \"public void ejbRemove() throws RemoteException \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"}\"'>'n '>'n" "'> \"public void setEntityContext(EntityContext ctx) throws RemoteException \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"}\"'>'n '>'n" "'> \"public void unsetEntityContext() throws RemoteException \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"}\"'>'n '>'n'>")))
 ...
 '(jde-bug-server-socket (quote (nil . "2112")) t)
 ...
 \" \" (jde-javadoc-code type) \" value\"")
 '(jde-gen-test-class-buffer-template (quote ("(funcall jde-gen-boilerplate-function) '>'n" "\"/**\" '>'n" "\" * \"" "(file-name-nondirectory buffer-file-name) '>'n" "\" *\" '>'n" "\" *\" '>'n" "\" * Created: \" (current-time-string) '>'n" "\" *\" '>'n" "\" * @author <a href=\\\"mailto:mrippa@jach.hawaii.edu \\\"\" (user-full-name)
\"</a>\"'>'n" "\" * @version\" '>'n" "\" */\" '>'n'" "'>'n" "\"public class \"" "(file-name-sans-extension (file-name-nondirectory
buffer-file-name))" "\" extends TestCase\"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n'n" "\"public \"" "(file-name-sans-extension (file-name-nondirectory
buffer-file-name))" "\" (String name)\"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"super(name);\"" "'>'p'n" "\"}\">" "'>'n'n" "\"protected void setUp() \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "'>'p'n" "\"}\">" "'>'n'n" "\"public static Test suite() \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"return new TestSuite(\"" "(file-name-sans-extension (file-name-nondirectory
buffer-file-name))" "\".class);\"'n" "'>'p'n" "\"}\">" "'>'n'n" "\"public static void main(String[] args) \"" "(if jde-gen-k&r " "()" "'>'n)" "\"{\"'>'n" "\"junit.textui.TestRunner.run(\"" "(file-name-sans-extension (file-name-nondirectory
buffer-file-name))" "\".class);\"'n" "'>'p'n" "\"}\">" "'>'n'n" "\"}\">" "\"// \"" "(file-name-sans-extension (file-name-nondirectory
buffer-file-name))" "'>'n")))
