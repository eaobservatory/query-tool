...
public class QT_MonResponse extends MonitorResponse {
     ...
     */
    public void Changed(DramaMonitor monitor, DramaTask task, String name,
            Arg value) throws DramaException {
        if (name.equals("CSOTAU")) {
            ...
            try {
                ...
                logger.error("DRAMA error reading JCMT_TAU_TIME: "
                        + e.toString());
            }
            ...
            logger.debug("Unhandled " + name + " update: "
