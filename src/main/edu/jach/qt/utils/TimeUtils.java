...
public class TimeUtils {
    ...
    /**
     * Checks whether the date/time <code>String</code> is in ISO format.
     *
    ...
    public static String convertLocalISODatetoUTC(String isoDate) {
        ...
        if (date != null) {
            ...
            int tzOffset = tz.getOffset(cal.get(Calendar.ERA),
                    ...
                    cal.get(Calendar.DAY_OF_WEEK), millsecondsOfDay);
     ...
     * @return Corresponding <code>Date</code> object or <code>null</code> on
     *         failure.
     */
