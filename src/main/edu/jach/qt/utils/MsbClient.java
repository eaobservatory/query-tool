...
public class MsbClient extends SoapClient {
    ...
    /**
     * Fetch the msb indicated by the msbid.
     *
     * The SpItem will return null on failure. In the future this should throw
    ...
    /**
     * Method to get the list of columns in an MSB Summary.
     *
     * Requires the <code>telescope</code> system parameter to be set.
     *
    ...
    /**
     * Method to get the list of column types in an MSB Summary.
     *
     * Requires the <code>telescope</code> system parameter to be set.
     *
