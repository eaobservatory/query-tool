...
public class TableSorter extends TableMap {
    ...
    /**
     * Contructor. Default contstructor which creates a 0 size
     * <code>TableMap</code>
     */
    public TableSorter() {
    ...
    /**
     * Constructor. Uses an existing model to contruct the <code>TableMap</code>.
     *
    ...
    /**
     * Compare the values is a specfic table column in two rows. Works
     * independently of the type of data in the column.
     *
    ...
    public int compareRowsByColumn(final int row1, final int row2,
         ...
         * used in this way but other subclasses of Number might want to do this
         * to save space and avoid unnecessary heap allocation.
         */
    ...
    /**
     * Checks whether the number of indices allocated matches the size of the
     * current Table model.
     */
     ...
     *
     * @param sender The object that sent the sort request (normally a colmun
     *            header).
     */
    ...
    /**
     * Sort the table by the specified column in either ascending or descending
     * order.
     *
     * @param column The index of the column to sort by.
