...
/**
 * <B>XmlUtils</B> is a utility method to get information about a XML document.
 *
 * It also retrieve data in an XML document.
 *
 * @author : Nazmul Idris: BeanFactory LLC, modified by Mathew Rippa
 *
 * @version : 1.0
 */
public class XmlUtils {
    ...
    public static OrderedMap<String, MSBTableModel> getNewModel(Document doc,
        ...
        for (int i = 0; i < rowsLength; i++) {
            ...
            // Now we have the model, loop through the elements and add these to
            // the model
    ...
    public static Vector<ProjectData> getProjectData() {
        return getProjectData(System.getProperty("msbSummary") + "."
    ...
    public static Vector<ProjectData> getProjectData(String xmlFileName) {
        ...
        try {
            ...
            System.err.println("WARNING: IOException Reading File "
                    + xmlFileName + ".");
            return null;
        } catch (SAXException sxe) {
            System.err
                    .println("SAXException Reading File " + xmlFileName + ".");
            sxe.printStackTrace();
            return null;
        }
    ...
    public static class SAXHandler extends DefaultHandler {
        ...
        public void characters(char[] ch, int start, int length) {
            ...
            } else if (_currentName.equals(_priority)
                    && getNextPriority == true) {
                String s = new String(ch);
                s = s.substring(start, start + length);
