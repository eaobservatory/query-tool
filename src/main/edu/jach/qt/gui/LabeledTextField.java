...
public class LabeledTextField extends WidgetPanel implements KeyListener,
        DocumentListener {
     ...
     * @param text a <code>String</code> value for the name of the
     *            LabeledTextField
     */
    public LabeledTextField(Hashtable<String, String> ht, WidgetDataBag wdb,
            String text) {
        super(ht, wdb);
