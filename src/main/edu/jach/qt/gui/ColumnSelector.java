...
/**
 * This class is used to display a series of checkboxes which allow a user to
 * define a subset of columns which they want to appear in a table.
 *
...
public class ColumnSelector extends JFrame implements ActionListener {
    ...
    /**
     * <code>ActionEvent</code> handler. This is run when the "Accept" button is
     * selected. It tells the model to update its columns. The selected columns
     * are passed as a <code>BitSet</code>. The window is then dismissed.
     *
